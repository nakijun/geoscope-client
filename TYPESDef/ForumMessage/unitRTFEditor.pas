...
uses
  ...
  ToolWin, ActnList, ImgList, Functionality, TypesFunctionality, unitForumMessagePanelProps;
...
type
  ...
  private
    ...
    FDragOfs: Integer;
    FDragging: Boolean;
    ForumMessagePanelProps: TForumMessagePanelProps;
  ...
  public
    Constructor Create(pForumMessagePanelProps: TForumMessagePanelProps);
    procedure Update;
  end;
...
Constructor TfmEditor.Create(pForumMessagePanelProps: TForumMessagePanelProps);
begin
Inherited Create(nil);
ForumMessagePanelProps:=pForumMessagePanelProps;
Update;
end;
...
try
ForumMessagePanelProps.reMessage.Lines.SaveToStream(MS);
MS.Position:=0;
...
var
  MS: TMemoryStream;
begin
with ForumMessagePanelProps do begin
MS:=TMemoryStream.Create;
try
