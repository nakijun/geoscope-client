...
Type
  ...
  TVideoRecorderModuleMode = (
    ...
    VIDEORECORDERMODULEMODE_FRAMESTREAM                 = 5
  );
...
const
  VideoRecorderModuleModeStrings: array[TVideoRecorderModuleMode] of string = ('?','H264 media stream','MPEG4 registrator','3GP registrator','H263 media stream','FRAME media stream');
