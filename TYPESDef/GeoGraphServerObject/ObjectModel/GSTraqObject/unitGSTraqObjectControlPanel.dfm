object GSTraqObjectControlPanel: TGSTraqObjectControlPanel
  Left = 388
  Top = 8
  BorderStyle = bsNone
  ClientHeight = 956
  ...
  object Panel1: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object GroupBox2: TGroupBox
        ...
        object gbConnectionModuleServiceProvider: TGroupBox
          ...
          object Label38: TLabel
            ...
            Height = 16
            AutoSize = False
            Caption = 'Keep Alive packet interval'
          end
          ...
          object edConnectionModuleServiceProviderKeepAliveInterval: TEdit
            Left = 168
            Top = 81
            Width = 121
            Height = 24
            AutoSize = False
            TabOrder = 5
            OnKeyPress = edConnectionModuleServiceProviderKeepAliveIntervalKeyPress
          end
          object edConnectionModuleServiceProviderIMEI: TEdit
            Left = 216
            Top = 49
            Width = 73
            Height = 24
            AutoSize = False
            TabOrder = 4
            OnKeyPress = edConnectionModuleServiceProviderIMEIKeyPress
          end
        end
        object edConnectionModulePassword: TEdit
          Left = 136
          Top = 205
          Width = 177
          Height = 24
          AutoSize = False
          TabOrder = 4
          OnKeyPress = edConnectionModulePasswordKeyPress
        end
        object GroupBox6: TGroupBox
          ...
          object Label43: TLabel
            ...
            Height = 16
            AutoSize = False
            Caption = 'Wiretapping Phone'
          end
          object edConnectionModuleVoiceModuleWiretappingPhoneNumber: TEdit
            Left = 128
            Top = 17
            Width = 161
            Height = 24
            AutoSize = False
            TabOrder = 0
            OnKeyPress = edConnectionModuleVoiceModuleWiretappingPhoneNumberKeyPress
          end
        end
      end
      ...
      object GroupBox4: TGroupBox
        ...
        object edBatteryModuleState: TEdit
          Left = 280
          Top = 22
          Width = 41
          Height = 24
      ...
      object gbADCModule: TGroupBox
        ...
        object edADCModuleValue1: TEdit
          Left = 96
          Top = 16
          Width = 57
          Height = 24
          AutoSize = False
          TabOrder = 0
          OnKeyPress = edADCModuleValue1KeyPress
        end
        object edADCModuleValue2: TEdit
          Left = 248
          Top = 16
          Width = 57
          Height = 24
          AutoSize = False
          TabOrder = 1
          OnKeyPress = edADCModuleValue2KeyPress
        end
      end
      object GroupBox7: TGroupBox
        ...
        object edCommandModuleCommand: TEdit
          Left = 80
          Top = 22
          Width = 241
          Height = 24
          AutoSize = False
          TabOrder = 0
          OnKeyPress = edCommandModuleCommandKeyPress
        end
        object edCommandModuleResponse: TEdit
          Left = 80
          Top = 50
          Width = 241
          Height = 24
