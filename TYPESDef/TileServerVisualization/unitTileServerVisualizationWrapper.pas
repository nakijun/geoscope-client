unit unitTileServerVisualizationWrapper;
...
type
  ...
  TfmTileServerVisualizationWrapper = class(TForm)
    memoMyPoints: TMemo;
    Label1: TLabel;
...
Constructor TfmTileServerVisualizationWrapper.Create(const pidPictureVisualization: integer);
begin
Inherited Create(nil);
idPictureVisualization:=pidPictureVisualization;
end;

procedure TfmTileServerVisualizationWrapper.Process;
...
Angle:=Angle/WC;
//. transforming
with TBase2DVisualizationFunctionality(TComponentFunctionality_Create(idTTileServerVisualization,idPictureVisualization)) do
try
...
procedure TfmTileServerVisualizationWrapper.PreparePointsListFromSpaceObj(const idTVisualization,idVisualization: integer; const List: TStrings);
var
  Obj: TSpaceObj;
  ptrPoint: TPtr;
  Point: TPoint;
...
procedure TfmTileServerVisualizationWrapper.sbProcessClick(Sender: TObject);
begin
Process;
end;

procedure TfmTileServerVisualizationWrapper.FormClose(Sender: TObject; var Action: TCloseAction);
begin
Action:=caFree;
end;

procedure TfmTileServerVisualizationWrapper.sbPrepareFromContainerClick(Sender: TObject);
begin
PreparePointsListFromSpaceObj(idTTileServerVisualization,idPictureVisualization, memoMyPoints.Lines);
end;

procedure TfmTileServerVisualizationWrapper.sbPreparefromClipboardVisualizationContainerClick(Sender: TObject);
begin
