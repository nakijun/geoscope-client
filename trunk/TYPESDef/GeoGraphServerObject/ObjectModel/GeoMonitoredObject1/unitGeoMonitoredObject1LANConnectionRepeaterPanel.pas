...
//.
FreeAndNil(Repeater);
Repeater:=TGeographProxyServerLANConnectionRepeater.Create(Address,Port, LocalPort, ServerAddress,DefaultServerPort, UserName,UserPassword, Model.ObjectController.idGeoGraphServerObject, Model.ControlModule_StartLANConnection,Model.ControlModule_StopLANConnection);
//.
