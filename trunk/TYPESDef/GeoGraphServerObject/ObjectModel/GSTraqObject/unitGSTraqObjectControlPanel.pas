unit unitGSTraqObjectControlPanel;
...
type
  TGSTraqObjectControlPanel = class(TObjectModelControlPanel)
    Panel1: TPanel;
    GroupBox1: TGroupBox;
    Label1: TLabel;
    Label2: TLabel;
    ...
    Label44: TLabel;
    edConnectionModuleServiceProviderIMEI: TEdit;
    ...
    procedure edCommandModuleCommandKeyPress(Sender: TObject;
      var Key: Char);
    procedure edConnectionModuleServiceProviderIMEIKeyPress(
      Sender: TObject; var Key: Char);
  private
    { Private declarations }
    Model: TGSTraqObjectModel;
  ...
  public
    ...
    Constructor Create(const pModel: TGSTraqObjectModel);
...
Constructor TGSTraqObjectControlPanel.Create(const pModel: TGSTraqObjectModel);
var
  I: integer;
begin
Inherited Create(pModel);
Model:=pModel;
ObjectRootComponent:=TGSTraqObjectComponent(Model.ObjectSchema.RootComponent);
DeviceRootComponent:=TGSTraqObjectDeviceComponent(Model.ObjectDeviceSchema.RootComponent);
//.
...
procedure TGSTraqObjectControlPanel.Update;
begin
Model.Lock.Enter;
try
...
edConnectionModuleServiceProviderIMEI.Text:=DeviceRootComponent.ConnectionModule.ServiceProvider.IMEI.Value;
...
procedure TGSTraqObjectControlPanel.edGeoSpaceIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edVisualizationTypeKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edVisualizationIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edHintIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edUserAlertIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edOnlineFlagIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edLocationIsAvailableFlagIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edDeviceDescriptorVendorIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edDeviceDescriptorModelIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edDeviceDescriptorSerialNumberKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edDeviceDescriptorProductionDateKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edDeviceDescriptorHWVersionKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edDeviceDescriptorSWVersionKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edConnectionModuleCheckpointIntervalKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edConnectionModuleServiceProviderIDKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edConnectionModuleServiceNumberKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edConnectionModuleServiceProviderTariffKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edConnectionModuleServiceProviderIMEIKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
Model.Lock.Enter();
try
DeviceRootComponent.ConnectionModule.ServiceProvider.IMEI.Value:=edConnectionModuleServiceProviderIMEI.Text;
finally
Model.Lock.Leave();
end;
...
procedure TGSTraqObjectControlPanel.edConnectionModuleServiceProviderKeepAliveIntervalKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edConnectionModulePasswordKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.edConnectionModuleVoiceModuleWiretappingPhoneNumberKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key <> #$0D) then Exit; //. ->
...
procedure TGSTraqObjectControlPanel.cbGPSModuleDatumIDChange(Sender: TObject);
var
  SC: TCursor;
begin
SC:=Screen.Cursor;
...
procedure TGSTraqObjectControlPanel.edGPSModuleDistanceThresholdKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edGPIModuleValueKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edGPOModuleValueKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.fmGPIModuleValueBitMapValueSet(const Value: word);
var
  SC: TCursor;
begin
SC:=Screen.Cursor;
...
procedure TGSTraqObjectControlPanel.fmGPIModuleValueBitMapValueSetBit(const Index: integer; const Value: boolean);
var
  W: word;
  Address: TAddress;
  SC: TCursor;
...
procedure TGSTraqObjectControlPanel.fmGPOModuleValueBitMapValueSet(const Value: word);
var
  SC: TCursor;
begin
if ((NOT Model.IsObjectOnline) AND (MessageDlg('Object is offline.'#$0D#$0A'Do you want to set it on the server side ?', mtConfirmation, [mbYes,mbNo], 0) = mrYes))
...
procedure TGSTraqObjectControlPanel.fmGPOModuleValueBitMapValueSetBit(const Index: integer; const Value: boolean);
var
  W: word;
  Address: TAddress;
  SC: TCursor;
...
procedure TGSTraqObjectControlPanel.bbUpdatePanelClick(Sender: TObject);
begin
//. update object model
ObjectRootComponent.ReadAll();
DeviceRootComponent.ReadAll();
...
procedure TGSTraqObjectControlPanel.UpdaterTimer(Sender: TObject);
begin
if (Model.IsObjectOnline())
 then begin
  lbConnectionModuleStatus.Caption:='Online';
...
procedure TGSTraqObjectControlPanel.Geographserverobjecttracing1Click(Sender: TObject);
var
  SC: TCursor;
...
procedure TGSTraqObjectControlPanel.Geographservercontroltracing1Click(Sender: TObject);
var
  SC: TCursor;
  LogDataStream: TMemoryStream;
  S: string;
...
procedure TGSTraqObjectControlPanel.edADCModuleValue1KeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edADCModuleValue2KeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
...
procedure TGSTraqObjectControlPanel.edCommandModuleCommandKeyPress(Sender: TObject; var Key: Char);
var
  SC: TCursor;
begin
if (Key = #$0D)
