unit unitTileServerVisualizationLocalContextLoader;
...
type
  TfmTileServerVisualizationLocalContextLoader = class(TForm)
    Panel1: TPanel;
  ...
  public
    { Public declarations }
    Constructor Create(const pSpace: TProxySpace; const pidTileServerVisualization: integer);
  end;
...
Constructor TfmTileServerVisualizationLocalContextLoader.Create(const pSpace: TProxySpace; const pidTileServerVisualization: integer);
begin
...
procedure TfmTileServerVisualizationLocalContextLoader.btnSelectContextPathClick(Sender: TObject);
var
  Path: string;
begin
...
procedure TfmTileServerVisualizationLocalContextLoader.LoadContextFromFolder(Folder: string);
  ...
  begin
  Folder:=Folder+'\'+'TileServerVisualizations'+'\'+IntToStr(idTileServerVisualization);
  DistFolder:=TTTileServerVisualizationCash(SystemTTileServerVisualization.Cash).Item_GetContextFolder(idTileServerVisualization);
  //.
  BytesCopied:=0;
  //.
...
procedure TfmTileServerVisualizationLocalContextLoader.btnStartLoadingClick(Sender: TObject);
begin
