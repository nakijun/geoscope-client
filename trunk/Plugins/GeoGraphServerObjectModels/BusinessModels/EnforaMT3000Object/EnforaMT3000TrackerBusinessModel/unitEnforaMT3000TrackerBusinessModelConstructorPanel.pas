unit unitEnforaMT3000TrackerBusinessModelConstructorPanel;
...
type
  TTEnforaMT3000TrackerBusinessModelConstructorPanel = class(TEnforaMT3000ObjectBusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
...
Constructor TTEnforaMT3000TrackerBusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTEnforaMT3000TrackerBusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTEnforaMT3000TrackerBusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
...
procedure TTEnforaMT3000TrackerBusinessModelConstructorPanel.ValidateValues();
begin
try
...
function TTEnforaMT3000TrackerBusinessModelConstructorPanel.Construct(const pUserID: integer; const pUserName: WideString; const pUserPassword: WideString; const pidGeographServer: integer; const pidGeoGraphServerObject: integer): integer;
var
  ...
  ObjectBusinessModel: TEnforaMT3000TrackerBusinessModel;
...
try
ObjectBusinessModel:=TEnforaMT3000TrackerBusinessModel(TBusinessModel.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
procedure TTEnforaMT3000TrackerBusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
