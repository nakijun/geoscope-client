unit unitEnforaMT3000TrackerBusinessModelDeviceInitializerPanel;
...
type
  TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel = class(TBusinessModelDeviceInitializerPanel)
    Timer: TTimer;
    GroupBox3: TGroupBox;
    GroupBox4: TGroupBox;
  ...
  private
    ...
    BusinessModel: TEnforaMT3000TrackerBusinessModel;
  ...
  public
    { Public declarations }
    Constructor Create(const pBusinessModel: TEnforaMT3000TrackerBusinessModel);
...
Constructor TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.Create(const pBusinessModel: TEnforaMT3000TrackerBusinessModel);
begin
...
Destructor TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.Destroy;
begin
Inherited;
end;

procedure TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.Update;
...
procedure TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.Enfora_SearchCOMPort();
var
  I: integer;
  Port: string;
  Response: shortstring;
...
procedure TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.Enfora_InitializeByCOM;
const
...
var
  ...
  I: integer;
begin
DeviceRootComponent:=TEnforaMT3000ObjectDeviceComponent(BusinessModel.ObjectModel.ObjectDeviceSchema.RootComponent);
//.
...
procedure TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.FormShow(Sender: TObject);
begin
memoEnforaModemID.SelectAll();
memoEnforaModemID.SetFocus();
end;

procedure TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.BitBtn1Click(Sender: TObject);
var
  SC: TCursor;
begin
SC:=Screen.Cursor;
...
procedure TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.bbEnforaWriteDeviceConfigurationClick(Sender: TObject);
var
  SC: TCursor;
begin
SC:=Screen.Cursor;
...
procedure TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.TimerTimer(Sender: TObject);
begin
Self.BringToFront();
end;

procedure TfmEnforaMT3000TrackerBusinessModelDeviceInitializerPanel.btnCopyEnforaModemIDToClipboardClick(Sender: TObject);
begin
