unit unitGMMDBusinessModelDeviceInitializerPanel;
...
type
  TfmGMMDBusinessModelDeviceInitializerPanel = class(TBusinessModelDeviceInitializerPanel)
    Timer: TTimer;
    GroupBox1: TGroupBox;
    Label1: TLabel;
    Label2: TLabel;
  ...
  private
    ...
    BusinessModel: TGMMDBusinessModel;
    
    procedure InitializeBySMS;
  public
    { Public declarations }
    Constructor Create(const pBusinessModel: TGMMDBusinessModel);
...
Constructor TfmGMMDBusinessModelDeviceInitializerPanel.Create(const pBusinessModel: TGMMDBusinessModel);
begin
...
Destructor TfmGMMDBusinessModelDeviceInitializerPanel.Destroy;
begin
Inherited;
end;

procedure TfmGMMDBusinessModelDeviceInitializerPanel.Update;
var
  ObjectName: string;
  ObjectType: integer;
...
//.
edDevicePhoneNumber.Text:=FormatFloat('0',(BusinessModel.ObjectModel as TGeoMonitoredMedDeviceModel).DeviceConnectorServiceProviderNumber());
//.
...
procedure TfmGMMDBusinessModelDeviceInitializerPanel.InitializeBySMS;
...
procedure TfmGMMDBusinessModelDeviceInitializerPanel.bbWriteDeviceConfigurationClick(Sender: TObject);
begin
InitializeBySMS();
end;

procedure TfmGMMDBusinessModelDeviceInitializerPanel.TimerTimer(Sender: TObject);
begin
Self.BringToFront();
end;
