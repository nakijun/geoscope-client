unit unitGMMDCardiographBusinessModelConstructorPanel;
...
type
  TTGMMDCardiographBusinessModelConstructorPanel = class(TGMMDBusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
    ...
    edMedDeviceModule: TGroupBox;
    Label20: TLabel;
    edDeviceMedDeviceDomains: TEdit;
...
Constructor TTGMMDCardiographBusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTGMMDCardiographBusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTGMMDCardiographBusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer); 
begin
...
procedure TTGMMDCardiographBusinessModelConstructorPanel.ValidateValues();
begin
try
...
var
  ...
  ObjectBusinessModel: TGMMDCardiographBusinessModel;
...
try
ObjectBusinessModel:=TGMMDCardiographBusinessModel(TBusinessModel.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
//.
ObjectBusinessModel.DeviceMedDeviceDomains:=DeviceMedDeviceDomains;
//.
...
procedure TTGMMDCardiographBusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
