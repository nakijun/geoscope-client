...
function TTNavixyObjectMainTrackerBusinessModelConstructorPanel.Construct(const pidGeographServer: integer; const pidGeoGraphServerObject: integer): integer;
var
