unit unitGMOGeoLogAndroidBusinessModelConstructorPanel;
...
uses
  ...
  unitGMOGeoLogAndroidBusinessModel, Buttons;

type
  TTGMOGeoLogAndroidBusinessModelConstructorPanel = class(TGMOBusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
...
Constructor TTGMOGeoLogAndroidBusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTGMOGeoLogAndroidBusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTGMOGeoLogAndroidBusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
...
procedure TTGMOGeoLogAndroidBusinessModelConstructorPanel.ValidateValues();
begin
try
...
function TTGMOGeoLogAndroidBusinessModelConstructorPanel.Construct(const pUserID: integer; const pUserName: WideString; const pUserPassword: WideString; const pidGeographServer: integer; const pidGeoGraphServerObject: integer): integer;
var
  ...
  ObjectBusinessModel: TGMOGeoLogAndroidBusinessModel;
...
try
ObjectBusinessModel:=TGMOGeoLogAndroidBusinessModel(TBusinessModel.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
procedure TTGMOGeoLogAndroidBusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
