unit unitGMOTrackLogger1BusinessModelConstructorPanel;
...
uses
  ...
  unitGMOTrackLogger1BusinessModel, Buttons;

type
  TTGMOTrackLogger1BusinessModelConstructorPanel = class(TGMOBusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
...
Constructor TTGMOTrackLogger1BusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTGMOTrackLogger1BusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTGMOTrackLogger1BusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
...
procedure TTGMOTrackLogger1BusinessModelConstructorPanel.ValidateValues();
begin
try
...
function TTGMOTrackLogger1BusinessModelConstructorPanel.Construct(const pUserID: integer; const pUserName: WideString; const pUserPassword: WideString; const pidGeographServer: integer; const pidGeoGraphServerObject: integer): integer;
var
  ...
  ObjectBusinessModel: TGMOTrackLogger1BusinessModel;
...
try
ObjectBusinessModel:=TGMOTrackLogger1BusinessModel(TBusinessModel.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
procedure TTGMOTrackLogger1BusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
