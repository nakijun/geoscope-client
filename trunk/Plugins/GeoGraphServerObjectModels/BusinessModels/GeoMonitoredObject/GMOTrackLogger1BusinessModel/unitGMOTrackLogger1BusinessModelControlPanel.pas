unit unitGMOTrackLogger1BusinessModelControlPanel;
...
uses
  ...
  unitObjectModel,
  unitBusinessModel,
  unitGMOTrackLogger1BusinessModel, StdCtrls, ExtCtrls, Buttons, ComCtrls;

type
  TGMOTrackLogger1BusinessModelControlPanel = class(TBusinessModelControlPanel)
    pnlHeader: TPanel;
  ...
  private
    ...
    Model: TGMOTrackLogger1BusinessModel;
    TracksPanel: TForm;
    TracksPanel_ReflectorID: integer;
  public
    { Public declarations }
    Constructor Create(const pModel: TGMOTrackLogger1BusinessModel);
...
{TGMOTrackLogger1BusinessModelControlPanel}
Constructor TGMOTrackLogger1BusinessModelControlPanel.Create(const pModel: TGMOTrackLogger1BusinessModel);
begin
...
Destructor TGMOTrackLogger1BusinessModelControlPanel.Destroy;
begin
ProxySpace_____TypesSystem____Reflector___GeoSpace__Tracks_FreePanel(TracksPanel);
Inherited;
end;

procedure TGMOTrackLogger1BusinessModelControlPanel.PostUpdate;
begin
Inherited;
end;

procedure TGMOTrackLogger1BusinessModelControlPanel.Update;
var
...
procedure TGMOTrackLogger1BusinessModelControlPanel.GetCurrentPosition();
var
  ptrObj: TPtr;
...
procedure TGMOTrackLogger1BusinessModelControlPanel.AddDayTrackToTheCurrentReflector(const BeginDate,EndDate: TDateTime);
var
  DaysCount: integer;
  TrackName: string;
...
procedure TGMOTrackLogger1BusinessModelControlPanel.bbObjectModelClick(Sender: TObject);
var
  W,H: integer;
begin
...
procedure TGMOTrackLogger1BusinessModelControlPanel.cbDisableObjectMovingClick(Sender: TObject);
var
  flUpdatingOld: boolean;
  SC: TCursor;
begin
...
procedure TGMOTrackLogger1BusinessModelControlPanel.cbDisableObjectClick(Sender: TObject);
var
  flUpdatingOld: boolean;
  SC: TCursor;
begin
...
procedure TGMOTrackLogger1BusinessModelControlPanel.UpdaterTimer(Sender: TObject);
begin
...
procedure TGMOTrackLogger1BusinessModelControlPanel.stNewTrackColorClick(Sender: TObject);
begin
ColorDialog.Color:=stNewTrackColor.Color;
if (ColorDialog.Execute) then stNewTrackColor.Color:=ColorDialog.Color;
end;

procedure TGMOTrackLogger1BusinessModelControlPanel.bbAddDayTrackToTheCurrentReflectorClick(Sender: TObject);
begin
AddDayTrackToTheCurrentReflector(TrackBeginDayPicker.DateTime,TrackEndDayPicker.DateTime);
end;

procedure TGMOTrackLogger1BusinessModelControlPanel.bbAddDayTrackToTheCurrentReflectorM1Click(Sender: TObject);
begin
AddDayTrackToTheCurrentReflector(TrackBeginDayPicker.DateTime-1.0,TrackEndDayPicker.DateTime-1.0);
end;

procedure TGMOTrackLogger1BusinessModelControlPanel.bbAddDayTrackToTheCurrentReflectorM2Click(Sender: TObject);
begin
AddDayTrackToTheCurrentReflector(TrackBeginDayPicker.DateTime-2.0,TrackEndDayPicker.DateTime-2.0);
end;

procedure TGMOTrackLogger1BusinessModelControlPanel.FormShow(Sender: TObject);
begin
Update();
end;

procedure TGMOTrackLogger1BusinessModelControlPanel.bbGetCurrentPositionClick(Sender: TObject);
var
  SC: TCursor;
begin
SC:=Screen.Cursor;
...
procedure TGMOTrackLogger1BusinessModelControlPanel.StressTesterTimer(Sender: TObject);
begin
