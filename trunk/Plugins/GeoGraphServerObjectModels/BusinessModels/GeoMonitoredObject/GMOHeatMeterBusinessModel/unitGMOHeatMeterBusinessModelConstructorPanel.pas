unit unitGMOHeatMeterBusinessModelConstructorPanel;
...
uses
  ...
  unitGMOHeatMeterBusinessModel, Buttons;

type
  TTGMOHeatMeterBusinessModelConstructorPanel = class(TGMOBusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
...
Constructor TTGMOHeatMeterBusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTGMOHeatMeterBusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTGMOHeatMeterBusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
...
procedure TTGMOHeatMeterBusinessModelConstructorPanel.ValidateValues();
begin
try
...
function TTGMOHeatMeterBusinessModelConstructorPanel.Construct(const pUserID: integer; const pUserName: WideString; const pUserPassword: WideString; const pidGeographServer: integer; const pidGeoGraphServerObject: integer): integer;
var
...
try
ObjectBusinessModel:=TGMOHeatMeterBusinessModel(TBusinessModel.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
procedure TTGMOHeatMeterBusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
