unit unitEnforaMiniMTTrackerBusinessModelConstructorPanel;
...
type
  TTEnforaMiniMTTrackerBusinessModelConstructorPanel = class(TEnforaMiniMTObjectBusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
...
Constructor TTEnforaMiniMTTrackerBusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTEnforaMiniMTTrackerBusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTEnforaMiniMTTrackerBusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
...
procedure TTEnforaMiniMTTrackerBusinessModelConstructorPanel.ValidateValues();
begin
try
...
function TTEnforaMiniMTTrackerBusinessModelConstructorPanel.Construct(const pUserID: integer; const pUserName: WideString; const pUserPassword: WideString; const pidGeographServer: integer; const pidGeoGraphServerObject: integer): integer;
var
  ...
  ObjectBusinessModel: TEnforaMiniMTTrackerBusinessModel;
...
try
ObjectBusinessModel:=TEnforaMiniMTTrackerBusinessModel(TBusinessModel.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
procedure TTEnforaMiniMTTrackerBusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
