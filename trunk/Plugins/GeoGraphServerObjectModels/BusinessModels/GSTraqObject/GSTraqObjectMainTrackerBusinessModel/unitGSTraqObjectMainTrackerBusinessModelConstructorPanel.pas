unit unitGSTraqObjectMainTrackerBusinessModelConstructorPanel;
...
type
  TTGSTraqObjectMainTrackerBusinessModelConstructorPanel = class(TGSTraqObjectBusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
    ...
    Label22: TLabel;
    edDeviceConnectorServiceIMEI: TEdit;
  ...
  private
    ...
    DeviceConnectorServiceIMEI: string;
...
Constructor TTGSTraqObjectMainTrackerBusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTGSTraqObjectMainTrackerBusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTGSTraqObjectMainTrackerBusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer); 
begin
...
procedure TTGSTraqObjectMainTrackerBusinessModelConstructorPanel.ValidateValues();
var
  I: integer;
begin
try
...
//.
DeviceConnectorServiceIMEI:=edDeviceConnectorServiceIMEI.Text;
//.
...
var
  ...
  ObjectBusinessModel: TGSTraqObjectMainTrackerBusinessModel;
...
try
ObjectBusinessModel:=TGSTraqObjectMainTrackerBusinessModel(TBusinessModel.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
ObjectBusinessModel.DeviceConnectionServiceProviderIMEI:=DeviceConnectorServiceIMEI;
...
procedure TTGSTraqObjectMainTrackerBusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
