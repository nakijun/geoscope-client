...
type
  ...
  display_call_fun = function(opaque : Pointer; picture : Pointer) : Pointer; cdecl;
  unlock_call_fun  = function(opaque : Pointer; picture : Pointer; plane : Pointer) : Pointer; cdecl;
...
begin
  ...
  if (Result = '') then Raise Exception.Create('VLC Player is not installed'); //. =>
end;
{$ENDIF}
...
begin
  ...
  if not libvlc_dll_get_proc_addr(@libvlc_video_get_adjust_int, // new in vlc 1.1.1
