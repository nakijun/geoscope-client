...
{ TCustomIpClient }
  ...
  public
    ...
    procedure Open(const ReadTimeout,WriteTimeout: integer); overload;
...
procedure TCustomIpClient.Open(const ReadTimeout,WriteTimeout: integer);
var
  addr: TSockAddr;
  //. modified by PAV
  Opt: integer;
...
function TCustomIpClient.Connect(const ReadTimeout,WriteTimeout: integer): Boolean;
begin
  Open(ReadTimeout,WriteTimeout);
  Result := FConnected;
end;
