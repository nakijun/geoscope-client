...
uses ShellConsts, ShellAPI, ComObj, TypInfo, Menus, Consts, Math, unitSpaceFunctionalServer{modified by PAV};
...
initialization
  ...
  //. modified by PAV
  if (NOT unitSpaceFunctionalServer.Yes()) then OleInitialize(nil);
...
finalization
  ...
  //. modified by PAV
  if (NOT unitSpaceFunctionalServer.Yes()) then OleUninitialize();
