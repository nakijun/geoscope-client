unit unitEnforaObjectTracker1BusinessModelConstructorPanel;
...
type
  TTEnforaObjectTracker1BusinessModelConstructorPanel = class(TEnforaObjectBusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
...
Constructor TTEnforaObjectTracker1BusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTEnforaObjectTracker1BusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTEnforaObjectTracker1BusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer); 
begin
...
procedure TTEnforaObjectTracker1BusinessModelConstructorPanel.ValidateValues();
begin
try
...
var
  ...
  ObjectBusinessModel: TEnforaObjectTracker1BusinessModel;
...
try
ObjectBusinessModel:=TEnforaObjectTracker1BusinessModel(BusinessModelClass.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
procedure TTEnforaObjectTracker1BusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
