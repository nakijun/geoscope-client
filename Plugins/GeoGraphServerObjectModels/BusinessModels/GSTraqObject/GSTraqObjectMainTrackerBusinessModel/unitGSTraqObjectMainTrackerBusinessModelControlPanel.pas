unit unitGSTraqObjectMainTrackerBusinessModelControlPanel;
...
uses
  ...
  unitObjectModel,
  unitBusinessModel,
  unitGSTraqObjectMainTrackerBusinessModel, Menus;

type
  TGSTraqObjectMainTrackerBusinessModelControlPanel = class(TBusinessModelControlPanel)
    pnlHeader: TPanel;
    ...
    procedure btnResetAlertClick(Sender: TObject);
  private
    { Private declarations }
    Model: TGSTraqObjectMainTrackerBusinessModel;
    TracksPanel: TForm;
    TracksPanel_ReflectorID: integer;
  public
    { Public declarations }
    Constructor Create(const pModel: TGSTraqObjectMainTrackerBusinessModel);
...
{TGSTraqObjectMainTrackerBusinessModelControlPanel}
Constructor TGSTraqObjectMainTrackerBusinessModelControlPanel.Create(const pModel: TGSTraqObjectMainTrackerBusinessModel);
begin
...
Destructor TGSTraqObjectMainTrackerBusinessModelControlPanel.Destroy;
begin
ProxySpace_____TypesSystem____Reflector___GeoSpace__Tracks_FreePanel(TracksPanel);
Inherited;
end;

procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.PostUpdate;
begin
Inherited;
end;

procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.Update;
var
...
procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.ResetAlert();
begin
Model.ResetAlert();
end;

procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.GetCurrentPosition();
var
  ptrObj: TPtr;
...
procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.bbObjectModelClick(Sender: TObject);
var
  W,H: integer;
begin
...
procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.properties1Click(Sender: TObject);
begin
bbObjectModelClick(nil);
end;

procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.cbDisableObjectMovingClick(Sender: TObject);
var
  flUpdatingOld: boolean;
  SC: TCursor;
begin
...
procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.cbDisableObjectClick(Sender: TObject);
var
  flUpdatingOld: boolean;
  SC: TCursor;
begin
...
procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.UpdaterTimer(Sender: TObject);
begin
...
procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.bbAddDayTrackToTheCurrentReflectorClick(Sender: TObject);
var
  TrackName: string;
...
procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.stNewTrackColorClick(Sender: TObject);
begin
ColorDialog.Color:=stNewTrackColor.Color;
if (ColorDialog.Execute) then stNewTrackColor.Color:=ColorDialog.Color;
end;

procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.FormShow(Sender: TObject);
begin
Update();
end;

procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.btnResetAlertClick(Sender: TObject);
var
  SC: TCursor;
begin
SC:=Screen.Cursor;
...
procedure TGSTraqObjectMainTrackerBusinessModelControlPanel.bbGetCurrentPositionClick(Sender: TObject);
var
  SC: TCursor;
begin
SC:=Screen.Cursor;
