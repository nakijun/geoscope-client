unit unitGMOHeatMeterBusinessModel;
Interface
uses
  Windows,
  SysUtils,
...
Type
  TGMOHeatMeterBusinessModel = class(TGMOBusinessModel)
  private
  ...
  public
    ...
    class function CreateCustomControlPanel(const idCoComponent: integer): TBusinessModelCustomControlPanel; override;
...
uses
  TypesDefines,
  FunctionalityImport,
  unitGMOHeatMeterBusinessModelControlPanel,
  unitGMOHeatMeterBusinessModelConstructorPanel,
  unitGMOHeatMeterBusinessModelCustomControlPanel;

Const
  GMOHeatMeterBusinessModelID = 3;


{TGMOHeatMeterBusinessModel}
class function TGMOHeatMeterBusinessModel.ID: integer;
begin
Result:=GMOHeatMeterBusinessModelID;
end;

class function TGMOHeatMeterBusinessModel.Name: string;
begin
Result:='HeatMeter';
end;

class function TGMOHeatMeterBusinessModel.CreateConstructorPanel(const pidGeoGraphServerObject: integer): TBusinessModelConstructorPanel;
begin
Result:=TTGMOHeatMeterBusinessModelConstructorPanel.Create(TGMOHeatMeterBusinessModel);
end;

class function TGMOHeatMeterBusinessModel.CreateCustomControlPanel(const idCoComponent: integer): TBusinessModelCustomControlPanel;
begin
Result:=TGMOHeatMeterBusinessModelCustomControlPanel.Create(idCoComponent);
end;

Constructor TGMOHeatMeterBusinessModel.Create(const pGeoMonitoredObjectModel: TGeoMonitoredObjectModel);
begin
...
procedure TGMOHeatMeterBusinessModel.Update;
begin
...
function TGMOHeatMeterBusinessModel.GetControlPanel: TBusinessModelControlPanel;
begin
ControlPanelLock.Enter;
try
if (ControlPanel = nil) then ControlPanel:=TGMOHeatMeterBusinessModelControlPanel.Create(Self);
Result:=ControlPanel;
finally
...
function TGMOHeatMeterBusinessModel.Object_GetHintInfo(const InfoType: integer; const InfoFormat: integer; out Info: TByteArray): boolean;
var
  Infos: string;
  _Name: string;
...
function TGMOHeatMeterBusinessModel.IsObjectOnline: boolean;
begin
Result:=(GeoMonitoredObjectModel.IsObjectOnline());
end;

function TGMOHeatMeterBusinessModel.CreateTrackEvent(const ComponentElement: TComponentElement; const Address: TAddress; const AddressIndex: integer; const flSetCommand: boolean): pointer;
...
procedure TGMOHeatMeterBusinessModel.setCheckpointInterval(Value: integer);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getCheckpointInterval: integer;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceDescriptorVendor(Value: DWord);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceDescriptorVendor: DWord;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceDescriptorModel(Value: DWord);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceDescriptorModel: DWord;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceDescriptorSerialNumber(Value: DWord);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceDescriptorSerialNumber: DWord;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceDescriptorProductionDate(Value: TDateTime);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceDescriptorProductionDate: TDateTime;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceDescriptorHWVersion(Value: DWord);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceDescriptorHWVersion: DWord;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceDescriptorSWVersion(Value: DWord);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceDescriptorSWVersion: DWord;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceConnectionServiceProviderID(Value: Word);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceConnectionServiceProviderID: Word;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceConnectionServiceNumber(Value: double);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceConnectionServiceNumber: double;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceConnectionServiceProviderSignal: Word;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setGeoSpaceID(Value: integer);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getGeoSpaceID: integer;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setVisualization(Value: TObjectDescriptor);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getVisualization: TObjectDescriptor;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setHintID(Value: integer);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getHintID: integer;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setUserAlertID(Value: integer);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getUserAlertID: integer;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setOnlineFlagID(Value: integer);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getOnlineFlagID: integer;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setLocationIsAvailableFlagID(Value: integer);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getLocationIsAvailableFlagID: integer;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceDatumID(Value: integer);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceDatumID: integer;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDeviceGeoDistanceThreshold(Value: integer);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceGeoDistanceThreshold: integer;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceConnectionServiceProviderAccount: Word;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceBatteryVoltage: Word;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getDeviceBatteryCharge: Word;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
function TGMOHeatMeterBusinessModel.getAlertSeverity: TTrackLoggerAlertSeverity;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDisableObjectMoving(Value: boolean);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
if (Value)
...
function TGMOHeatMeterBusinessModel.getDisableObjectMoving: boolean;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
...
procedure TGMOHeatMeterBusinessModel.setDisableObject(Value: boolean);
begin
GeoMonitoredObjectModel.Lock.Enter;
try
if (Value)
...
function TGMOHeatMeterBusinessModel.getDisableObject: boolean;
begin
GeoMonitoredObjectModel.Lock.Enter;
try
