unit unitGMO1TrackLogger1BusinessModelConstructorPanel;
...
uses
  ...
  unitGMO1TrackLogger1BusinessModel, Buttons;

type
  TTGMO1TrackLogger1BusinessModelConstructorPanel = class(TGMO1BusinessModelConstructorPanel)
    edGeoSpaceID: TEdit;
...
Constructor TTGMO1TrackLogger1BusinessModelConstructorPanel.Create(const pBusinessModelClass: TBusinessModelClass);
var
  I: integer;
begin
...
procedure TTGMO1TrackLogger1BusinessModelConstructorPanel.Preset(const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer);
begin
Preset1(2{Yandex.Maps}, idTVisualization,idVisualization, idHint, idUserAlert, idOnlineFlag,idLocationIsAvailableFlag);
end;

procedure TTGMO1TrackLogger1BusinessModelConstructorPanel.Preset1(const idGeoSpace: integer; const idTVisualization,idVisualization: integer; const idHint: integer; const idUserAlert: integer; const idOnlineFlag: integer; const idLocationIsAvailableFlag: integer); 
begin
...
procedure TTGMO1TrackLogger1BusinessModelConstructorPanel.ValidateValues();
begin
try
...
function TTGMO1TrackLogger1BusinessModelConstructorPanel.Construct(const pUserID: integer; const pUserName: WideString; const pUserPassword: WideString; const pidGeographServer: integer; const pidGeoGraphServerObject: integer): integer;
var
  ...
  ObjectBusinessModel: TGMO1TrackLogger1BusinessModel;
...
try
ObjectBusinessModel:=TGMO1TrackLogger1BusinessModel(TBusinessModel.GetModel(ObjectModel,BusinessModelClass.ID));
try
...
procedure TTGMO1TrackLogger1BusinessModelConstructorPanel.sbSelectGeoSpaceClick(Sender: TObject);
var
  GeoSpaceID: integer;
  GeoSpaceName: string;
begin
