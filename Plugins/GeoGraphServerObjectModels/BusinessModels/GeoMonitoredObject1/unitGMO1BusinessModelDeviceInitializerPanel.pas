unit unitGMO1BusinessModelDeviceInitializerPanel;
...
type
  TfmGMO1BusinessModelDeviceInitializerPanel = class(TBusinessModelDeviceInitializerPanel)
    Timer: TTimer;
    GroupBox1: TGroupBox;
    Label1: TLabel;
    Label2: TLabel;
...
Constructor TfmGMO1BusinessModelDeviceInitializerPanel.Create(const pBusinessModel: TGMO1BusinessModel);
begin
...
Destructor TfmGMO1BusinessModelDeviceInitializerPanel.Destroy;
begin
Inherited;
end;

procedure TfmGMO1BusinessModelDeviceInitializerPanel.Update;
var
  ObjectName: string;
  ObjectType: integer;
...
//.
edDevicePhoneNumber.Text:=FormatFloat('0',(BusinessModel.ObjectModel as TGeoMonitoredObject1Model).DeviceConnectorServiceProviderNumber());
//.
...
procedure TfmGMO1BusinessModelDeviceInitializerPanel.InitializeBySMS;
...
procedure TfmGMO1BusinessModelDeviceInitializerPanel.bbWriteDeviceConfigurationClick(Sender: TObject);
begin
InitializeBySMS();
end;

procedure TfmGMO1BusinessModelDeviceInitializerPanel.TimerTimer(Sender: TObject);
begin
Self.BringToFront();
end;
